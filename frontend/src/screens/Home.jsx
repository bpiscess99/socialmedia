...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // fetching all posts
    fetch("http://localhost:5000/api/createpost/allposts", {
      headers: {
  ...
  const likePost = (id) => {
    fetch("http://localhost:5000/api/createpost/like", {
      method: "put",
      headers: {
  ...
  const unLikePost = (id) => {
    fetch("http://localhost:5000/api/createpost/unlike", {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("jwt"),
  ...
  const makeComment = (text, id) => {
    fetch("http://localhost:5000/api/createpost/comment", {
      method: "put",
      headers: {
        "Content-type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("jwt"),
            ...
            <div className="card" key={posts._id}>
              ...
              <div className="card-header">
                <div className="card-pic">
                  <img src={posts.postedBy.Photo ? posts.postedBy.Photo : picLink} alt="img" />
                </div>
